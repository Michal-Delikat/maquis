...
const SPACE_RUE_BARADAT = 1;
const SPACE_FENCE = 2;
const SPACE_PONT_DU_NORD = 3;
const SPACE_RADIO_B = 4;
const SPACE_DOCTOR = 5;
const SPACE_POOR_DISTRICT = 6;
const SPACE_BLACK_MARKET = 7;
const SPACE_RIGHT_TOP_SPARE_ROOM = 8;
const SPACE_RADIO_A = 9;
const SPACE_LEFT_SPARE_ROOM = 10;
const SPACE_PONT_LEVEQUE = 11;
const SPACE_GROCER = 12;
const SPACE_RIGHT_BOTTOM_SPARE_ROOM = 13;
const SPACE_LEFT_FIELD = 14;
const SPACE_CAFE = 15;
const SPACE_SAFE_HOUSE = 16;
const SPACE_RIGHT_FIELD = 17;
const SPACE_MISSION_A_SPACE_A = 18;
const SPACE_MISSION_A_SPACE_B = 19;
const SPACE_MISSION_A_SPACE_C = 20;
const SPACE_MISSION_B_SPACE_A = 21;
const SPACE_MISSION_B_SPACE_B = 22;
const SPACE_MISSION_B_SPACE_C = 23; 
